import type { RotatedDetectionModel } from "./types";
const DATABASE = "web-sdk-pp-rotated-detection-models-v1";
const STORE = "models";
export function modelCacheKey(model: RotatedDetectionModel): string {
...
export async function clearCurrentModelCache(
