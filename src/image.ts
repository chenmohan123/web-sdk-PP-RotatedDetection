...
export async function readPixels(
  ...
  if (typeof createImageBitmap !== "function")
    throw new RotatedDetectionError("UNSUPPORTED", "当前环境不支持图片解码");
  ...
  try {
    ...
    const canvas =
      typeof OffscreenCanvas !== "undefined"
        ...
        : typeof document !== "undefined"
          ...
          : undefined;
    if (!canvas)
      throw new RotatedDetectionError("UNSUPPORTED", "当前环境没有图片画布");
    ...
    const ctx = canvas.getContext("2d") as
      ...
      | null;
    if (!ctx)
      throw new RotatedDetectionError("UNSUPPORTED", "无法建立图片画布");
