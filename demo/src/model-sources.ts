import type { RotatedDetectionModel } from "../../src/types";
...
function modelIdentity(value: unknown): RotatedDetectionModel | undefined {
...
function parseSource(value: unknown, identity: RotatedDetectionModel) {
